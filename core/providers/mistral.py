...
class MistralProvider(BaseProvider):
    """Mistral LLM Provider integration wrapper."""

    def __init__(self):
        super().__init__(name="mistral", category=ProviderCategory.LLM, is_optional=True)
        self.api_key = Config.MISTRAL_API_KEY
        self.primary_model = Config.MISTRAL_MODEL

    def initialize(self) -> bool:
        if not self.api_key:
            self.last_error = "MISTRAL_API_KEY is missing."
