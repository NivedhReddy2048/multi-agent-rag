...
# Add project root to sys.path before any local package imports
...
def build_benchmark_engine():
    ...
    chunk_a = Document(page_content=doc_a_text, metadata={"source_file": "doc_a_transformer_spec.txt", "document_id": "doc_a", "page_number": 1, "chunk_id": "chunk_a_1"})
    chunk_b = Document(page_content=doc_b_text, metadata={"source_file": "doc_b_encoder_spec.txt", "document_id": "doc_b", "page_number": 1, "chunk_id": "chunk_b_1"})
    chunk_c = Document(page_content=doc_c_text, metadata={"source_file": "doc_c_database_indexing.txt", "document_id": "doc_c", "page_number": 1, "chunk_id": "chunk_c_1"})
    chunk_conf_a = Document(page_content=doc_conf_a_text, metadata={"source_file": "doc_conf_a.txt", "document_id": "doc_conf_a", "page_number": 1, "chunk_id": "chunk_conf_a_1"})
    chunk_conf_b = Document(page_content=doc_conf_b_text, metadata={"source_file": "doc_conf_b.txt", "document_id": "doc_conf_b", "page_number": 1, "chunk_id": "chunk_conf_b_1"})
...
def run_all_scenarios():
    print("Initializing Benchmark Engine and OrchestratorAgent...")
    ...
    for sc in scenarios:
        ...
        print(f"Target Doc: {sc['target_doc']}")
        print(f"==================================================")
    ...
    output_path = Path(__file__).parent / "step2d_benchmark_results.json"
    with open(output_path, "w", encoding="utf-8") as f:
        json.dump(results, f, indent=2)

    print(f"\nBenchmark Execution Complete! Saved results to {output_path}")
